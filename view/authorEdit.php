...
if ($error_count == 0 && trim($form)) {
    @header("location: " . Page::getUrl() . "author/list");
} else {
    ?>
    <div class="content">
            ...
            <section id="adm-information" class="row">
                ...
                <div class="col-sm-12" style="padding-top: 50px">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="well">
                                <form class="form-horizontal" role="form" id="form-crear-author" action="<?php echo Page::getUrl() ?>author/edit/<?php echo $author_id ?>" method="POST">
